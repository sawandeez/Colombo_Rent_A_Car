    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/payments/payhere/notify", "/api/payments/payhere/notify").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/payments/mock/checkout", "/api/payments/mock/checkout").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/payments/mock/complete", "/api/payments/mock/complete").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/bookings").hasAnyRole("CUSTOMER", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/bookings/*/payments/initiate", "/api/bookings/*/payments/initiate").hasAnyRole("CUSTOMER", "ADMIN")
